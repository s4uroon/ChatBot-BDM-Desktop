...
class MainWindow(QMainWindow):
    ...
    def _on_conversation_loaded(self, conv_data: dict):
        ...
        self.status_bar.showMessage(f"Session '{conv_data['title']}' loaded")
    ...
    def _start_api_worker(self):
        ...
        self.chat_widget.append_message('assistant', '⏳ Processing response...')
    ...
    def _on_chunk_received(self, chunk: str):
        ...
        self.logger.debug(f"[MAIN_WINDOW] Chunk reçu, taille totale: {len(self.current_response)} chars")
    ...
    def _on_about(self):
        ...
        QMessageBox.about(
            ...
            "<h2>🤖 ChatBot BDM Desktop</h2>"
            "<p><b>Version:</b> 1.0.0</p>"
            "<p><b>Creator:</b> Gwendal CHAIGNEAU BOEZENNEC</p>"
            "<p><b>Framework:</b> PyQt6</p>"
            "<p><b>API:</b> OpenAI Compatible</p>"
            "<br>"
            "<p>Professional chatbot application with:</p>"
            "<ul>"
            "<li>✅ Streaming support</li>"
            "<li>✅ Syntax highlighting (Highlight.js)</li>"
            "<li>✅ JSON/Markdown export</li>"
            "<li>✅ SSL bypass for self-signed servers</li>"
